 ...
 */
public class GArco extends Arc2D.Double implements GFigura {

    private AtribCompuesto propiedades;
    private Dibujante dibujante;

    /**
     * Constructor de figura "Arco".
     *
     * @param p1 Punto de origen de la figura.
     * @param p2 Punto final de la figura.
     */
    public GArco(Point2D p1, Point2D p2) {
        super(p1.getX(), p1.getY(), 0, 0, 50, 50, Arc2D.OPEN);
