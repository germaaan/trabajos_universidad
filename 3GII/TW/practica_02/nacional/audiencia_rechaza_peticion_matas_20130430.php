...
<head>
    ...
    <title>PlaceHolder - NACIONAL. La Audiencia rechaza la petición de Matas de que el juez Castro deje el caso Nóos</title>
	...
	<section id="noticia_destacada">
		<article class="nacional">
			<figure id="figura_noticia_destacada">
				<img class="img_noticia_destacada" src="./audiencia_rechaza_peticion_matas_20130430/imagen_01.jpg"  
					 alt="audiencia_rechaza_peticion_matas_20130430"/>
				<figcaption> Urdangarin dice que el juez investiga sus declaraciones para <cite>"ver qué sale"</cite> </figcaption>
			</figure>
			<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(1)"> NACIONAL. La Audiencia rechaza la petición de Matas de que el juez Castro deje el caso Nóos </h2>
				<h3> Autor: EFE </h3>
			</hgroup>
            <p class="cont_noticia"> La Audiencia de Palma ha desestimado un recurso presentado por la defensa del expresidente de Baleares 
				Jaume Matas en el que pedía la inhibición del juez José Castro de la instrucción del caso Nóos y ha 
				confirmado que el magistrado es competente para instruir esta causa de presunta corrupción.<br/><br/>
				La sección segunda de este tribunal rechaza en un auto los argumentos esgrimidos por la defensa de Matas 
				de que el juez debe inhibirse al considerar que no es competente porque los hechos investigados no tienen 
				nada que ver con el sobrecoste en la construcción del Palma Arena, causa principal de la que deriva el caso 
				Nóos.<br/><br/>
				Sin embargo, los magistrados de la Audiencia consideran que el juez Castro tiene competencia territorial 
				para instruir esta causa, que está conectada con el caso Palma Arena por la investigación de las actuaciones 
				de Matas cuando era presidente balear entre 2003 y 2007, ha informado el Tribunal Superior de Justicia de 
				Baleares.<br/><br/>
				En el caso Nóos, pieza separada número 25 del caso Palma Arena, se investiga el presunto desvío de fondos 
				públicos de varias administraciones al Instituto Nóos que presidieron Iñaki Urdangarin y Diego Torres, y a 
				la Fundación Deporte, Cultura e Integración Social (Fdcis).<br/><br/>
				Matas está imputado en esta pieza separada por los convenios que firmó el Govern balear con Nóos cuando él 
				era presidente para organizar dos foros de turismo y deporte y la oficina de prensa del equipo ciclista 
				Illes Balears.<br/><br/>
				Los magistrados de la Audiencia señalan que el juez Castro no ejerce la acción penal de oficio en esta 
				causa, sino que cuando apreció indicios de posibles delitos instó al Ministerio Fiscal a investigarlos.
				En el auto en el que desestiman el recurso, añaden que la inhibición tendría que haberse solicitado al 
				inicio de la instrucción y no cuando ya se habían practicado numerosas diligencias.<br/><br/>
				El juez José Castro, cuando rechazó inhibirse de la instrucción a petición de Matas en un auto dictado en 
				mayo de 2012, manifestó que su abogado no había recurrido las 17 resoluciones que ya había adoptado en 
				relación a esta causa.<br/><br/>
				En el recurso de apelación que planteó ante la Audiencia, el abogado de Matas, Antonio Alberca, aseguraba 
				que al rechazar su solicitud de inhibición, el instructor vulneró el derecho de su defendido al juez natural 
				predeterminado por ley.<br/><br/>
				Además criticaba que en el auto en el que rechazó inhibirse, Castro no hiciera <cite>"ni una referencia a la 
				cuestión capital de qué tiene que ver el Palma Arena con esa supuesta estrategia de los responsables de 
				Nóos para apoderarse de fondos públicos y privados a lo largo y ancho de la geografía española, o para 
				desviar recursos a paraísos fiscales o para defraudar a Hacienda"</cite>.<br/><br/>
        </article>
	</section>
