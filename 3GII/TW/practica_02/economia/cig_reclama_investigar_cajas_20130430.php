...
<head>
    ...
    <title>PlaceHolder - ECONOMIA. La CIG reclama "investigar a fondo lo que sucedió con las cajas" y la gestión del FROB y el actual equipo directivo</title>
...
<section id="cuerpo">
	...
	<section id="noticia_destacada">
		<article class="economia">
			<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(3)"> ECONOMIA. La CIG reclama "investigar a fondo lo que sucedió con las cajas" y la gestión del FROB y el 
					 actual equipo directivo </h2>
				<h3> Autor: lainformacion.com </h3>
			</hgroup>
			<p class="cont_noticia"> El responsable de CIG-Banca, Clodomiro Montero, ha reclamado este martes <cite>"investigar a fondo lo que 
				sucedió con las cajas gallegas"</cite>, pero también las decisiones adoptadas por el Fondo de Reestructuración 
				Ordenada Bancaria (FROB), que controla actualmente el 100% de la entidad, y de su equipo gestor, con el 
				fin de determinar las causas de su situación.<br/><br/>
				Montero ha destacado las pérdidas de 7.938 millones de euros registradas el año pasado por la entidad 
				y ha considerado que <cite>"vienen dadas"</cite> por las disposiciones gubernativas que han obligado al sector a provisionar 
				<cite>"todo el ladrillo"</cite> y que han llevado a que muchos bancos hayan entrado en pérdidas.<br/><br/>
				En el caso de NCG Banco, se han registrado unas pérdidas <cite>"brutales"</cite>, que han quedado cubiertas con las 
				inyecciones de ayudas realizadas a la entidad. El resultado negativo queda <cite>"amortizado"</cite>, ha indicado, pero 
				ha incidido en la necesidad de abrir una investigación.<br/>
				La comisión que comenzará a trabajar próximamente en el Parlamento gallego <cite>"llega tarde"</cite>, a juicio de 
				la CIG. En cualquier caso, ha advertido de que es necesario investigar no sólo lo que ocurrió con las propias 
				cajas, sino la gestión posterior.<br/><br/>
				Montero ha indicado, además, que NCG Banco ha confirmado con una comunicación interna a los empleados 
				que la UGAS <strong>--la Unidad de Gestión de Activos Singulares, que gestiona los activos inmobiliarios problemáticos--</strong>,
				el grupo inmobiliario, la red de recuperación masiva y red exterior están en venta.<br/><br/>
				A este respecto, ha reclamado <cite>"todos los datos"</cite> a la entidad sobre a quién se venderían estos 
				departamentos y qué efectos tendrían sobre los empleados. Además, ha dicho no entender que se haya 
				presentado un ERE si había posibilidad de deshacerse de negocio mediante la venta.<br/><br/>
        </article>
	</section>
