...
<head>
    ...
    <title>PlaceHolder - DEPORTES. Pete Mickeal deja el basket en 'stand by' por su enfermedad</title>
	...
	<section id="noticia_destacada">
		<article class="deportes">
			<figure id="figura_noticia_destacada">
				<img class="img_noticia_destacada" src="./mickeal_deja_basket_enfermedad_20133004/imagen_01.jpg"  
					 alt="mickeal_deja_basket_enfermedad_20133004"/>
				<figcaption> Pete Mickeal </figcaption>
			</figure>
			<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(4)"> DEPORTES. Pete Mickeal deja el basket en 'stand by' por su enfermedad </h2>
				<h3> Autor: EFE </h3>
			</hgroup>
            <p class="cont_noticia"> El alero estadounidense del Barcelona Regal, Pete Mickael, ha explicado hoy que se desplazará a 
				Estados Unidos para tratarse del tromboembolismo pulmonar que se le reprodujo hace un mes, por lo que no 
				sabe si volverá en <cite>"cuatro meses, un año o será para siempre"</cite>.<br/><br/>
				<cite>"En dos semanas voy a Estados Unidos para ver a un especialista en este problema, que ha tratado a 
				diferentes jugadores de la NBA. No sé cuánto tiempo estaré, si cuatro meses, seis, un año o para siempre. Lo 
				más importante ahora es mi salud"</cite>, ha afirmado.<br/><br/>
				En una abarrotada sala de prensa del Palau Blaugrana, junto a su técnico, Xavi Pascual, así como el 
				director deportivo, Joan Creus, y sus compañeros de vestuario, un emocionado Mickeal, que en algunos momentos 
				no ha podido reprimir las lágrimas, ha reconocido que el baloncesto es ahora <cite>"una segunda opción"</cite>.<br/><br/>
				<cite>"Lo más importante no es el baloncesto. Es una segunda opción. Lo más importante es recuperarme, estar 
				sano, solucionar los problemas con mi sangre"</cite>, ha dicho el alero norteamericano, que ha elogiado a su 
				entrenador y la manera cómo el club le ha tratado, que le ha hecho <cite>"abrir los ojos y la mente"</cite>.<br/><br/>
				<cite>"Solo tengo palabras de agradecimiento. Cuando eres jugador de baloncesto, solo piensas en hacer veinte 
				puntos, tantos rebotes, los años de contrato y el salario. Pero cuando miras atrás, ves las cosas diferentes. 
				No hay ningún otro club en el mundo como el Barça, ni en la NBA ni en Europa"</cite>, ha recalcado el jugador de 35 
				años.<br/><br/>
				Y ha subrayado: <cite>"Mientras siga manteniendo estas ganas de jugar y ganar, no lo dejaré. Les he dicho a 
				Sandro <strong>(Rosell)</strong>, Joan <strong>(Creus)</strong> y Xavi <strong>(Pascual)</strong> que si alguna vez puedo seguir jugando a baloncesto, será solo 
				en este club"</cite>.<br/><br/>
				Hace algo más de un mes, y tras perderse un partido en Sevilla, el Barcelona informó que Mickeal había 
				recaído en un problema respiratorio que dos temporadas atrás ya le dejó fuera de la competición durante 
				meses.<br/><br/>
        </article>
	</section>
