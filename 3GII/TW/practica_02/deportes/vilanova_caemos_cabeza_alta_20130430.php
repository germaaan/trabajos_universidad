...
<head>
    ...
    <title>PlaceHolder - DEPORTES. Tito Vilanova: "Si caemos, debe ser con la cabeza bien alta"</title>
...
<section id="cuerpo">
	...
	<section id="noticia_destacada">
		<article class="deportes">
			<iframe class="youtube-player" type="text/html" width="593" height="334" src="http://www.youtube.com/embed/c4VyzDNicU0"
					frameborder="0"> </iframe>
			<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(4)"> DEPORTES. Tito Vilanova: "Si caemos, debe ser con la cabeza bien alta" </h2>
				<h3> Autor: 20minutos </h3>
			</hgroup>
			<p class="cont_noticia"> El técnico del FC Barcelona, Tito Vilanova, ha dicho que su equipo <cite>"luchará"</cite> para remontar la 
				eliminatoria de semifinales de Liga de Campeones ante el Bayern, tras el 4-0 del partido de ida, y 
				ha apuntado que, si al final cae derrotado, deberá ser <cite>"con la cabeza bien alta"</cite>.<br/><br/>
				<cite>"Espero que seamos nosotros mismos. Intentaremos ser mejores que el Bayern y eso pasará por que 
				juguemos bien, seamos nosotros mismos y juguemos bien a fútbol"</cite>, ha afirmado el preparador en la rueda de 
				prensa en la ciudad deportiva, en la previa del partido.<br/><br/>
				Según Vilanova, sus jugadores <cite>"son conscientes de la dificultad"</cite>, pero <cite>"no se puede dar una eliminatoria 
				por perdida con noventa minutos por delante en el Camp Nou"</cite>.<br/><br/>
				<cite>"Somos el Barça"</cite>, ha recordado, precisamente las mismas palabras que ha utilizado minutos antes uno de sus 
				jugadores, Gerard Piqué, cuando ha comparecido también en sala de prensa ante una multitud de medios locales 
				e internacionales acreditados para el choque.<br/><br/>
				<cite>"Si esta eliminatoria no la pasamos <strong>-ha aseverado Tito-</strong>, debemos hacerlo con la cabeza bien alta, no bajar 
				los brazos y que la gente se sienta orgullosa de nosotros"</cite>.<br/><br/>
				El técnico ha reconocido que <cite>"está claro que con el resultado adverso se deberá intentar mantener la 
				portería a cero, pues un gol complicaría más las cosas"</cite>. <cite>"Y no se puede pensar solo en hacer goles, hacer 
				goles, sino que lo importante es cómo los hacemos, en base al juego y ser mejores que el Bayern"</cite>, ha reiterado.<br/><br/>
				Vilanova ha descartado a Mascherano para el encuentro y ha sido prudente respecto al concurso de Sergio 
				Busquets, quien se perdió el partido ante el Athletic por unas molestias en el pubis: <cite>"Después del entreno 
				valoraremos si está cien por cien para este partido"</cite>.<br/><br/>
        </article>
	</section>
