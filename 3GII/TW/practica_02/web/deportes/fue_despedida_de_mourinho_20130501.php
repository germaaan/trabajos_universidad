...
<head>
    ...
    <title>PlaceHolder - DEPORTES. ¿Fue la despedida de Mourinho?</title>
...
<section id="cuerpo">
	...
	<section id="noticia_destacada">
		<article class="deportes">
			<iframe class="youtube-player" type="text/html" width="593" height="334" src="http://www.youtube.com/embed/IiVnu26SoSs"
					frameborder="0"> </iframe>
			<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(4)"> DEPORTES. ¿Fue la despedida de Mourinho? </h2>
				<h3> Autor: sportyou </h3>
			</hgroup>
			<p class="cont_noticia"> Las palabras de José Mourinho, en declaraciones a la televisión inglesa ITV nada más terminar el duelo 
				contra el Borussia Dortmund, sonaron a despedida. El luso, dejó con ellas la puerta abierta a un salida 
				inminente del Real Madrid. <cite>“Quizá no. Estaré donde la gente me quiera”</cite>, contestó al preguntarle por su 
				continuidad en el banquillo blanco la próxima temporada. <cite>“Quiero pensar al final de temporada. Me gusta 
				estar donde la gente me quiere sin reservas”</cite>, añadió posteriormente en rueda de prensa.
				También sobre su futuro, se quejó del trato recibido por la prensa y dejó caer que su futuro está más 
				cerca de la Premier League y el Chelsea que del Real Madrid. <cite>“
				<br/><br/>Sé que en Inglaterra me quieren, sobre todo 
				un equipo, pero primero quiero ganar la final de Copa y quedar segundo y luego hablaremos con Florentino“. </cite>
				<cite>“Allí <strong>(Inglaterra)</strong> me tratan con justicia. En España es diferente porque algunos me odian. Algunos están 
				aquí <strong>(refiriéndose a los periodistas presentes en la sala de prensa)</strong>”</cite><br/>
				En zona mixta se mostró satisfecho del esfuerzo realizado por sus jugadores contra el Borussia Dortmund. 
				<cite>“Lo han dado todo”</cite>. El luso explicó el resultado por la poca efectividad de su equipo en ataque. <cite>“El fútbol 
				es marcar o no marcar y no marcamos”</cite> Mourinho valoró positivamente el buen arranque de su equipo y lamentó 
				las oportunidades despercidiadas. <cite>“Hemos fallado ocasiones importantes, y en la segunda parte hemos arriesgado. 
				Hemos jugado contra un equipo que es más rápido que nosotros y han tenido dos ocasiones claras”</cite>.<br/><br/>
				El portugués también quiso analizar el arbitraje de Howard Webb, al que criticó por la distribución de 
				las amonestaciones. <cite>“Es increíble que no haya sacado roja a Hummels para que juegue la final”</cite>, aseveró. <cite>“Por 
				perdonar una roja a un jugador ha perjudicado a un equipo”</cite> Según Mourinho, Webb <cite>“dejó por un momento de ser 
				árbitro para ser hombre”</cite>.<br/><br/>
        </article>
	</section>
