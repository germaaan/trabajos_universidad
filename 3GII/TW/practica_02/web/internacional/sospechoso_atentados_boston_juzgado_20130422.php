...
<head>
    ...
    <title>PlaceHolder - INTERNACIONAL. El sospechoso vivo de los atentados de Boston no será juzgado como combatiente enemigo</title>
	...
	<section id="noticia_destacada">
		<article class="internacional">
			<figure id="figura_noticia_destacada">
				<img class="img_noticia_destacada" src="./sospechoso_atentados_boston_juzgado_20130422/imagen_01.jpg"  
			...
			<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(2)"> INTERNACIONAL. El sospechoso vivo de los atentados de Boston no será juzgado como combatiente enemigo </h2>
				<h3> Autor: EFE </h3>
			</hgroup>
			<p class="cont_noticia"> El presunto coautor de los atentados de Boston, Dzhokhar Tsarnaev, no será tratado como <cite>"combatiente 
				enemigo"</cite> y será juzgado ante un tribunal civil, anunció hoy el portavoz de la Casa Blanca, Jay Carney.<br/><br/>
				El portavoz argumentó que cuando se trata de ciudadanos estadounidenses como es el caso de Tsarnaev <cite>"va 
				contra la ley"</cite> aplicar ese estatus de <cite>"combatiente enemigo"</cite>, que implica un proceso a través de la justicia 
				militar, como reclaman algunos republicanos.<br/><br/>
				<cite>"Vamos a procesar a este terrorista a través de nuestro sistema de justicia civil"</cite>, dijo el portavoz del 
				presidente de EE.UU., Barack Obama, durante su rueda de prensa diaria.<br/><br/>
				Carney recordó que desde los atentados del 11 de septiembre de 2001 <cite>"se ha utilizado el sistema de 
				justicia federal" para "condenar y encarcelar a cientos de terroristas"</cite>.<br/><br/>
				El procesamiento de Tsarnaev, de 19 años, en un tribunal civil <cite>"es la forma apropiada de actuar"</cite>, 
				subrayó el portavoz al insistir en que <cite>"cuando se trata de ciudadanos de Estados Unidos va contra la ley 
				presentarlos ante comisiones militares"</cite>.<br/><br/>
				Tsarnaev fue detenido el pasado viernes por la noche e ingresado de inmediato en el hospital Beth Israel 
				de Boston, donde hoy continua en estado <cite>"grave"</cite>, según el último informe de la Oficina Federal de 
				Investigaciones (FBI).<br/><br/>
				Desde el domingo por la noche el joven se comunica con los investigadores federales por escrito, ya 
				que tiene lesiones en la garganta ocurridas durante el tiroteo con policías en el que falleció su hermano, 
				Tamerlan.<br/><br/>
				Los dos hermanos Tsarnaev son considerados los presuntos autores de los atentados de hace una semana 
				durante el popular maratón de Boston, donde fallecieron tres personas y más de 180 resultaron heridas.<br/><br/>
				Tamerlan, de 26 años, murió en un tiroteo con las autoridades en la madrugada del pasado viernes en el 
				que también falleció un policía.<br/><br/>
        </article>
	</section>
