...
<head>
    ...
    <title>PlaceHolder - INTERNACIONAL. El Gobierno de Letta logra la investidura definitiva en el Parlamento italiano</title>
	...
	<section id="noticia_destacada">
		<article class="internacional">
			<figure id="figura_noticia_destacada">
				<img class="img_noticia_destacada" src="./gobierno_letta_logra_investidura_20130430/imagen_01.jpg"  
					 alt="gobierno_letta_logra_investidura_20130430"/>
				<figcaption> El Gobierno de Letta logra la investidura definitiva en el Parlamento italiano </figcaption>
			</figure>
			<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(2)"> INTERNACIONAL. El Gobierno de Letta logra la investidura definitiva en el Parlamento italiano </h2>
				<h3> Autor: EFE </h3>
			</hgroup>
			<p class="cont_noticia"> El nuevo Ejecutivo italiano de coalición, presidido por el demócrata Enrico Letta, logró hoy la 
				investidura definitiva en el Parlamento de Italia, al superar también con una amplia mayoría el voto 
				de confianza en el Senado.<br/><br/>
				Por 233 votos a favor, 59 en contra y 18 abstenciones, el Gobierno, que integran el Partido Demócrata 
				(PD) de centroizquierda, el conservador Pueblo de la Libertad (PDL) de Silvio Berlusconi y la centrista 
				Elección Cívica de Mario Monti, volvió a lograr un amplio apoyo parlamentario después de que ayer recibiera 
				la aprobación de la Cámara de los Diputados por 453 votos (de 630 posibles).<br/><br/>
				Desde las elecciones de hace dos meses, el Senado se había convertido en el principal escollo para la 
				formación del Gobierno italiano, después de que el líder de la coalición vencedora, Pier Luigi Bersani, no 
				lograra en ella la mayoría absoluta y no pudiera tampoco conseguir los apoyos necesarios para su Ejecutivo.<br/><br/>
				El bloqueo político se resolvió con el encargo de formar Gobierno a Letta, mano derecha de Bersani en el 
				PD, y el acuerdo alcanzado entre este partido, el de Berlusconi y el de Monti, formaciones que hoy también 
				apoyaron al Ejecutivo con un voto positivo.<br/><br/>
				Como ya sucediera ayer en la Cámara de los Diputados, el Movimiento 5 Estrellas del cómico Beppe Grillo 
				y los ya exsocios del PD Izquierda Ecología y Libertad votaron en contra, mientras que se abstuvo la 
				secesionista Liga Norte, al considerar que los puntos planteados por Letta en su programa no les satisfacen 
				del todo.<br/><br/>
				Antes incluso de contar con la aprobación del Senado al Gobierno, surgieron hoy las primeras muestras en 
				público de discrepancias en el seno de la coalición de Gobierno entre el PDL y el PD sobre el impuesto a la 
				vivienda habitual reintroducido por Monti y cuyo pago de junio quedará suspendido, según anunció Letta ayer.<br/><br/>
				El nuevo ministro para las Relaciones con el Parlamento, Dario Franceschini, del PD, dijo hoy que sobre 
				este impuesto habrá una <cite>"prórroga para el pago de junio"</cite> para después revisarlo, algo que puso en pie de 
				guerra ya al partido de Berlusconi, que durante la campaña electoral se comprometió no solo a quitarlo, 
				sino a devolver lo pagado en 2012.<br/><br/>
        </article>
	</section>
