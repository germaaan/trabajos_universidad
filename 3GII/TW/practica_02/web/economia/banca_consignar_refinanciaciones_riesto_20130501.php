...
<head>
    ...
    <title>PlaceHolder - ECONOMIA. La banca deberá consignar las refinanciaciones como operaciones de alto riesgo de impago</title>
	...
	<section id="noticia_destacada">
		<article class="economia">
			<figure id="figura_noticia_destacada">
				<img class="img_noticia_destacada" src="./banca_consignar_refinanciaciones_riesto_20130501/imagen_01.jpg"  
					 alt="banca_consignar_refinanciaciones_riesto_20130501"/>
				<figcaption> El gobernador del Banco de España, Luis María Linde. </figcaption>
			</figure>
				<hgroup>
				<h2 onmouseover="ventanaNoticiasRelacionadas(3)"> ECONOMIA. La banca deberá consignar las refinanciaciones como operaciones de alto riesgo de impago </h2>
				<h3> Autor: Bruno Pérez </h3>
			</hgroup>
			<p class="cont_noticia"> Las refinanciaciones, renegociaciones, reestructuraciones de crédito y todas aquellas operaciones realizadas 
				por la banca con el objetivo de acomodar los plazos de pago de un préstamo para facilitar su pago deberán ser 
				consignadas en el balance de la entidad con carácter general como operaciones de riesgo subestándar, es decir, 
				de alta probabilidad de impago.<br/><br/>
				Así lo ha determinado el Banco de España en una comunicación a las entidades financieras en la que precisa 
				los criterios que deben observar a la hora no sólo de reflejar en su contabilidad este tipo de operaciones, sino 
				también a la hora de realizarlas.
				La entidad que preside Luis María Linde advierte de que tiene intención de supervisar muy de cerca la 
				actuación de los bancos en esta materia, tanto en el programa de inspección de este año como en eventuales 
				actuaciones que se programen de forma especial con esta finalidad.<br/><br/>
				La norma persigue que la banca utilice las refinanciaciones de forma prudente y <cite>"sin desvirtuar el 
				reconocimiento del deterioro"</cite> que suponen ante el riesgo de impago, informa EFE.<br/><br/>
        </article>
	</section>
