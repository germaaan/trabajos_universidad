...
// yuscula. Para ello habra que usar una estructura repetitiva "do while", de forma que
// si el usuario introduce un caracter que no sea una letra mayuscula, se le volvera a
// pedir otro caracter. Calculad la minuscula correspondiente e imprimidla en pantalla.
