...
* **int SiCoEn.Encriptador.getAlgoritmo()**: Método que devuelve el código interno del algoritmo actual del encriptador. *Definición en la línea 135 del archivo Encriptador.java.*
